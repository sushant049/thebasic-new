...
export const FinalCTA = () => {
  ...
  return (
    ...
    >
      {/* Soft accent glow */}
      <div className="absolute -top-40 -right-20 w-[480px] h-[480px] rounded-full bg-[#C0561D]/15 blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 text-center">
        <motion.span
          ...
          className="text-[10px] tracking-[0.32em] uppercase text-[#C0561D]"
        >
          The Basic Ecosystem
        </motion.span>
        ...
        >
          ...
          <br />
          <em className="not-italic text-[#E89465]">
        ...
        >
          <button
            ...
            className="group inline-flex items-center justify-between gap-8 bg-[#F2F6FB] text-[#0F2A47] hover:bg-[#C0561D] hover:text-[#F2F6FB] transition-all duration-500 px-8 py-4 text-[11px] uppercase tracking-[0.28em]"
          >
            Book a Consultation
          ...
          <button
            ...
            className="group inline-flex items-center gap-3 text-[#F2F6FB] hover:text-[#C0561D] px-2 py-4 text-[11px] uppercase tracking-[0.28em] transition-colors"
          >
