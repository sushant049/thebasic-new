...
const inputClasses =
  "h-12 w-full border-0 border-b border-[#5A7BA0]/50 rounded-none bg-transparent px-0 py-2 text-base text-[#0F2A47] placeholder:text-[#5A7BA0]/70 focus-visible:ring-0 focus-visible:border-[#CF5B2E] focus-visible:outline-none transition-colors font-light";
      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-[56px] font-light text-[#0F2A47] leading-[1.05] tracking-tight">
            Have a property,
            <br />
            <em className="not-italic text-[#CF5B2E]">villa, building,</em>
            <br />
            or land?
          </h2>
          ...
          <div className="mt-10 pt-8 border-t border-[#D3E0EE] space-y-4">
            <div>
              ...
              <a
                ...
                className="font-serif text-xl text-[#0F2A47] hover:text-[#CF5B2E] transition-colors"
              >
        ...
        >
          {submitted ? (
            ...
            >
              <div className="w-12 h-12 rounded-full bg-[#CF5B2E]/15 border border-[#CF5B2E]/30 flex items-center justify-center">
                <Check className="text-[#CF5B2E]" strokeWidth={1.5} />
              </div>
              ...
              <button
                ...
                className="mt-10 text-[11px] uppercase tracking-[0.28em] text-[#1F3A5F] hover:text-[#CF5B2E] transition-colors"
              >
            ...
            >
                ...
                <div>
                  ...
                  >
                    <SelectTrigger
                      ...
                      className="h-12 w-full border-0 border-b border-[#5A7BA0]/50 rounded-none bg-transparent px-0 text-base text-[#0F2A47] focus:ring-0 focus:border-[#CF5B2E]"
                    >
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={4}
                  className="w-full border-0 border-b border-[#5A7BA0]/50 rounded-none bg-transparent px-0 py-3 text-base text-[#0F2A47] placeholder:text-[#5A7BA0]/70 focus-visible:ring-0 focus-visible:border-[#CF5B2E] focus-visible:outline-none transition-colors font-light resize-none"
                />
              </div>
              ...
              <div className="pt-4">
                <button
                  ...
                  className="group inline-flex items-center justify-between gap-8 bg-[#0F2A47] text-[#F2F6FB] hover:bg-[#CF5B2E] transition-all duration-500 px-8 py-4 text-[11px] uppercase tracking-[0.28em]"
                >
                  Send Enquiry
